...
public class ThroughputMonthVO {
    ...
    public List<ThroughputMonthVO> convertToThroughputVO(List<ThroughputMonth> throughputMonthList){
        ...
        for (int i=0;i<throughputMonthList.size();i++){
            ThroughputMonthVO throughputMonthVO=new ThroughputMonthVO(throughputMonthList.get(i).getInsDate(),throughputMonthList.get(i).getThCntrTotal().multiply(BigDecimal.valueOf(20)),"1");
            throughputMonthVOList.add(throughputMonthVO);
            throughputMonthVO=new ThroughputMonthVO(throughputMonthList.get(i).getInsDate(),throughputMonthList.get(i).getThCargoTotal(),"2");
            throughputMonthVOList.add(throughputMonthVO);
        }
