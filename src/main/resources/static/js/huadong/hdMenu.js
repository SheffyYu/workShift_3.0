                ...
                console.log(nodes);
              	...
              	for(var i=0;i<nodes.length;i++) {
                    ...
                    mainMenu1.append(li);
    	                        ...
    	                        $("#"+node.PARENT_ID+"one").append( "<li class='subnav-li' href='"+node.URL+"' data-id='"+i+"one'><a href='javascript:;' class='ue-clear'><i class='subnav-icon'></i><span class='subnav-text'>"+node.TEXT+"</span></a></li>");
